...
public class Ventana extends JFrame{
    ...
    public Ventana() {
        setSize(800, 680); //Establece el tamaño de la ventana
    ...
    private void ColocarEtiquetas() {
        ...
        etiqueta.setBounds(50, 10, 230, 30); //Establecemos la posicion y dimensiones de la etiqueta
        ...
        etiqueta1.setBounds(50, 300, 400, 35);
        ...
        etiqueta2.setBounds(50, 370, 400, 35);
        ...
        etiqueta3.setBounds(50, 440, 700, 35);
        ...
        etiqueta4.setBounds(50, 560, 420, 35);
    ...
    private void ColocarBoton() {
     ...
     // Boton operar
        ...
        boton1.setBounds(400, 10, 100, 35); // Asignamos la posicion y dimension del boton dentro del panel
        panel.add(boton1); // agregamos el boton al panel
        
     // Boton limpiar
        boton2 = new JButton();
        boton2.setText("Limpiar");
        boton2.setBounds(511, 10, 100, 35);
    ...
    private void ColocarCajaDeTexto() {
      //caja de texto inicial  
        ...
        cajaTexto.setBounds(290, 10, 100, 35); // establecemos la posicion y dimension de la caja de texto
        panel.add(cajaTexto);
        eventoCajaDeTexto();
    ...
    private void ColocarJTextPane() { // Funcion que crea el textpane donde se coloca la matriz
        ...
        textoEstilizado.setBounds(150, 70, 450, 220);
